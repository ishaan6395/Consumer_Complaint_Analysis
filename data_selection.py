...
vectorizer = TfidfVectorizer(stop_words = stop_words, use_idf = True, max_features = 2000)
...
with open('sparse_dense_2000.pkl', 'wb') as f:
    pickle.dump(x.todense(), f)
print('data stored in sparse_dense_1000.pkl')